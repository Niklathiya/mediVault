    ...
    visits: [
      {
        ...
        dept: 'General',
        notes: 'Blood sugar review, adjusted metformin dose.',
      },
      {
        date: '08 Jun 2026',
        doctor: 'Dr. Priya Mehta',
        dept: 'General',
        notes: 'Routine checkup, BP controlled.',
      },
    ],
    prescriptions: [
      {
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 18 }}>
          ...
          <div style={{ flex: 1 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 4 }}>
              <h2 style={{ margin: 0, fontSize: 22, fontWeight: 600, color: C.text }}>
                {patient.name}
              </h2>
              {patient.hasAllergy && (
                <span
          ...
          <span
            style={{
              ...
              padding: '4px 12px',
              borderRadius: 10,
              background: 'rgba(78,179,116,0.1)',
              color: '#15803d',
              fontWeight: 500,
            }}
          >
        ...
        {tab === 'prescriptions' && (
          ...
          >
            <div
              style={{
                display: 'grid',
                gridTemplateColumns: '1fr 0.6fr 0.6fr 1fr',
                padding: '12px 20px',
                background: C.subtleBg,
                fontSize: 11,
                letterSpacing: '0.06em',
