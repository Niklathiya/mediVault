  ...
  return (
    <div style={{ marginBottom: 14 }}>
      ...
      >
        ...
        <span
          style={{ fontSize: 12, color: 'var(--fg-on-light-muted)', flexShrink: 0, marginLeft: 8 }}
        >
          {count} {suffix}
        </span>
      </div>
    ...
    >
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 14 }}>
        <div style={card}>
          ...
          <div
            style={{ fontSize: 34, fontWeight: 300, color: 'var(--fg-on-light)', lineHeight: 1 }}
          >
            {kpi.patients}
          </div>
        ...
        <div style={card}>
          ...
          <div style={{ fontSize: 28, fontWeight: 300, color: '#15803d', lineHeight: 1 }}>
            {kpi.revenue}
          </div>
        ...
        <div style={card}>
          ...
          {[
            ...
            <div key={b.label} style={{ marginBottom: 14 }}>
              ...
              >
                <span style={{ fontSize: 12, fontWeight: 500, color: b.labelColor }}>
                  {b.label}
                </span>
                <span style={{ fontSize: 12, color: 'var(--fg-on-light-muted)' }}>
                  {b.count} bills · {pct(b.count)}%
                </span>
              </div>
              <div
                style={{
          ...
          >
            ...
            <strong style={{ color: 'var(--fg-on-light)' }}>{billTotal}</strong>
          </div>
        </div>
              ...
              >
                ...
                >
                  <div
                    style={{
                      width: '44%',
                      height: `${(t.patients / TREND_MAX) * 60}px`,
                      background: '#4eb374',
                  ...
                  <div
                    style={{
                      width: '44%',
                      height: `${(t.admissions / TREND_MAX) * 60}px`,
                      background: '#0891b2',
                      borderRadius: '2px 2px 0 0',
                      transition: 'height 600ms',
                    }}
