...
const BILLS = [
  {
    ...
    initials: 'RP',
    date: '25 Jun 2026',
    items: ['IPD (3 days)', 'Surgery OT', 'Medications', 'Lab Tests'],
    amount: 28500,
    paid: 28500,
    status: 'Paid',
  },
  {
    ...
    initials: 'SS',
    date: '24 Jun 2026',
    items: ['ICU (4 days)', 'Investigations', 'Nursing'],
    amount: 52000,
    paid: 26000,
    status: 'Partial',
  },
  {
    ...
    initials: 'AM',
    date: '23 Jun 2026',
    items: ['Surgery OT', 'Anaesthesia', 'Post-op care'],
    amount: 35000,
    paid: 0,
    status: 'Unpaid',
  },
  {
    ...
    initials: 'PJ',
    date: '22 Jun 2026',
    items: ['Delivery room', 'OB care', 'Neonatal'],
    amount: 18000,
    paid: 18000,
    status: 'Paid',
  },
  {
    ...
    initials: 'VK',
    date: '21 Jun 2026',
    items: ['General ward (7 days)', 'Lab reports'],
    amount: 14000,
    paid: 7000,
    status: 'Partial',
  },
  {
    ...
    initials: 'RN',
    date: '18 Jun 2026',
    items: ['Ortho surgery', 'Physiotherapy', 'Implant'],
    amount: 68000,
    paid: 68000,
    status: 'Paid',
  },
  {
    ...
    initials: 'SG',
    date: '16 Jun 2026',
    items: ['General ward (12 days)', 'Medicines'],
    amount: 22000,
    paid: 0,
    status: 'Unpaid',
  },
    ...
    <div style={{ animation: 'mv-fade 200ms ease both' }}>
      ...
      >
        <div
          style={{
            display: 'grid',
            gridTemplateColumns: '1.8fr 1fr 1fr 1fr 1fr 80px',
            padding: '12px 20px',
        ...
        {filtered.map((b) => {
          ...
          return (
            ...
            >
              ...
              <div style={{ fontSize: 13, color: 'var(--fg-on-light-muted)' }}>
              ...
              <div>
                ...
                {balance > 0 && (
                  <div style={{ fontSize: 11, color: '#d9a441' }}>Balance: {fmt(balance)}</div>
                )}
              </div>
              <div>
                <span
              ...
              <div
                style={{ textAlign: 'right', display: 'flex', gap: 6, justifyContent: 'flex-end' }}
              >
                <button
          ...
          >
            ...
            >
              <div>
                ...
                <div style={{ fontSize: 12, color: 'var(--fg-on-light-muted)', marginTop: 2 }}>
                  {selectedBill.patient} · {selectedBill.date}
                </div>
              </div>
              <button
              ...
              {selectedBill.items.map((item, i) => (
                <div
                  ...
                  style={{
                    ...
                    padding: '10px 0',
                    borderBottom:
                      i < selectedBill.items.length - 1 ? '1px solid var(--border-card)' : 'none',
                  }}
                >
                  <span style={{ fontSize: 13, color: 'var(--fg-on-light)' }}>{item}</span>
                  <span style={{ fontSize: 13, color: 'var(--fg-on-light-muted)' }}>
                    {fmt(Math.floor(selectedBill.amount / selectedBill.items.length))}
                  </span>
                </div>
              ))}
            </div>
            ...
            <div style={{ background: 'var(--surface-subtle)', padding: '16px 24px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
                ...
                <span style={{ fontSize: 13, fontWeight: 600, color: 'var(--fg-on-light)' }}>
              ...
              >
                <span style={{ fontSize: 14, fontWeight: 600, color: 'var(--fg-on-light)' }}>
                  Balance due
                </span>
                <span
                  style={{
                    fontSize: 14,
                    fontWeight: 700,
                    color: selectedBill.amount - selectedBill.paid > 0 ? '#d95050' : '#15803d',
                  }}
                >
