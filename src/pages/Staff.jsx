            ...
            >
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: 14, marginBottom: 14 }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ fontSize: 11, color: 'var(--fg-on-light-subtle)', marginTop: 1 }}>
                    {m.dept} · {m.exp}
                  </div>
                </div>
                <span
