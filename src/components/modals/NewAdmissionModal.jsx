...
const PATIENTS = [
  ...
  'Anjali Shah (PT-0125)', 'Mohan Trivedi (PT-0124)', 'Lakshmi Nair (PT-0123)',
];
const WARDS = ['General Ward', 'ICU', 'Surgery', 'Maternity', 'Orthopaedic', 'Paediatric'];
const DOCTORS = ['Dr. Priya Mehta', 'Dr. Arjun Rao', 'Dr. Kavita Singh', 'Dr. Rishi Patel', 'Dr. Anil Sharma'];
      ...
      >
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div>
              <div style={{ fontSize: 15, fontWeight: 700, color: 'var(--fg-on-light)' }}>New IPD Admission</div>
              <div style={{ fontSize: 12, color: 'var(--fg-on-light-muted)', marginTop: 1 }}>Create an inpatient admission record</div>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        >
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
            ...
            <label style={{ display: 'block' }}>
              ...
              <input style={inp} placeholder="e.g. 4A" value={form.bed} onChange={e => set('bed', e.target.value)} />
            </label>
          </div>
          ...
          <label style={{ display: 'block' }}>
            ...
            <input style={inp} required placeholder="Primary diagnosis / chief complaint" value={form.reason} onChange={e => set('reason', e.target.value)} />
          </label>
